    ...
    cards: [
      {
        ...
        description: "Where it all began — captured mid broadcast, camera light still warming up.",
      },
      {
        id: "ls-002",
        name: "Chat Overload",
        ...
        description: "The moment chat scrolls faster than anyone can read it.",
      },
      {
        id: "ls-014",
        name: "Clutch Play",
        number: "014/040",
        rarity: "rare",
        image: "images/cards/ls-014.png",
        description: "One life left, chat holding its breath.",
      },
      {
        id: "ls-027",
        name: "Sub Goal Hit",
